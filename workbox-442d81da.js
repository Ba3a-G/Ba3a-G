define(["exports"], (function(t) {
    ...
    const c = {
        ...
        h = t => [c.prefix, t, c.suffix].filter((t => t && t.length > 0)).join("-"),
        u = t => t || h(c.precache),
        l = t => t || h(c.runtime);
    ...
    class U {
        constructor(t, e) {
            this.u = {}, Object.assign(this, e), this.event = e.event, this.l = t, this.p = new m, this.g = [], this.R = [...t.plugins], this.m = new Map;
        ...
        async cacheMatch(t) {
            ...
            const {
                cacheName: n,
                matchOptions: i
            } = this.l, r = await this.getCacheKey(e, "read"), o = Object.assign(Object.assign({}, i), {
                cacheName: n
            });
        ...
        async cachePut(t, e) {
            ...
            const {
                cacheName: c,
                matchOptions: h
            } = this.l, u = await self.caches.open(c), l = this.hasCallback("cacheDidUpdate"), f = l ? await async function(t, e, s, n) {
                const i = R(e.url, s);
                ...
                const r = Object.assign(Object.assign({}, n), {
                    ...
                    o = await t.keys(e, r);
                for (const e of o)
                    if (i === R(e.url, s)) return t.match(e, n)
    ...
    class L extends class {
        ...
        async q(t, e, n) {
            ...
            try {
                if (i = await this.L(e, t), !i || "error" === i.type) throw new s("no-response", {
                    url: e.url
                })
            } catch (s) {
        ...
        constructor(t = {}) {
            t.cacheName = u(t.cacheName), super(t), this._ = !1 !== t.fallbackToNetwork, this.plugins.push(L.copyRedirectedCacheableResponsesPlugin)
        }
        async L(t, e) {
        ...
        async O(t, e) {
            let n;
            const i = e.params || {};
            if (!this._) throw new s("missing-precache-entry", {
                ...
                n = await e.fetch(new Request(t, {
                    integrity: r || s
                })), s && o && (this.N(), await e.cachePut(t, n.clone()))
            }
            return n
        }
        async C(t, e) {
        ...
        N() {
            let t = null,
                e = 0;
            for (const [s, n] of this.plugins.entries()) n !== L.copyRedirectedCacheableResponsesPlugin && (n === L.defaultPrecacheCacheabilityPlugin && (t = s), n.cacheWillUpdate && e++);
    ...
    class b {
        ...
        addToCacheList(t) {
            ...
            for (const n of t) {
                ...
                if (this.k.has(i) && this.k.get(i) !== t) throw new s("add-to-cache-list-conflicting-entries", {
                    firstEntry: this.k.get(i),
                    secondEntry: t
                });
                if ("string" != typeof n && n.integrity) {
                    if (this.T.has(t) && this.T.get(t) !== n.integrity) throw new s("add-to-cache-list-conflicting-integrities", {
                        url: i
                    });
    ...
    function x(t) {
        ...
        ! function(t, e, n) {
            ...
            } else if (t instanceof RegExp) c = new r(t, e, n);
            else if ("function" == typeof t) c = new i(t, e, n);
            else {
...
//# sourceMappingURL=workbox-442d81da.js.map
